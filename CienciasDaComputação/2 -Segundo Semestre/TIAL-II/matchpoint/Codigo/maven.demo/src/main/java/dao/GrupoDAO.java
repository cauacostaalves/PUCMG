...
public class GrupoDAO extends DAO {
    ...
    public boolean verGrupoDuplicado(String nomeGrupo) throws Exception {
        String sql = "SELECT COUNT(*) FROM grupos WHERE nome = ?";
        ...
        try (PreparedStatement stmt = conexao.prepareStatement(sql)) {
            ...
            e.printStackTrace();
            throw new Exception("Erro ao verificar duplicidade de grupo no banco de dados.", e);
        }
