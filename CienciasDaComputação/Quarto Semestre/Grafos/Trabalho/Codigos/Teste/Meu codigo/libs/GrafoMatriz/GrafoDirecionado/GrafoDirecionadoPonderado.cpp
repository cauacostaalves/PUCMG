#include <iostream>
#include "GrafoDirecionadoPonderado.hpp"
using namespace std;
...
void CriarArestas_DP(Vertice_DP **grafo, int vert){
    ...
    while (maxvert > 0)
    {
        ...
        {
            cout << "Vertice_DPs invalidas! Por favor escreva arestas entre A e " << char('A' + vert - 1) << endl;
            continue;
        }
...
void DFS_DP(Vertice_DP **grafo,int vert){
    cout << "Digite o Vertice_DPs que deseja começar: " << endl;
    char Vertice_DP;
    cin >> Vertice_DP;
}
